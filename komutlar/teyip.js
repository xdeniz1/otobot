...
const radio = {
    ...
    "old town road": "http://188.138.57.100/tb/b/6e/lil_nas_x_old_town_road_feat._billy_ray_cyrus_remix_mp3_66831.mp3"
}
      ...
      if (!args) return msg.channel.send(':x: | Bir Radyo Seçin : **franceinfo**, **rtl2**, **skyrock**, **rtl**, **rfm**, **bfm**,**old town road**')

        if(!radio[args]) return msg.channel.send(':x: | Lütfen Yandaki Radiolardan Birini Seç : **franceinfo**, **rtl2**, **skyrock**, **rtl**, **rfm**, **bfm**')
